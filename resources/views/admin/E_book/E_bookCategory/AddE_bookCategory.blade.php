...
<div class="card-body">
    ...
    <form class="needs-validation" novalidate="" action="{{ route('E_bookCategoryStore') }} " method="post" >
        @csrf
        ...
        <div class="card-body">
                <div class="form-group col-12">
                    <div class="section-title mt-0">Add E-Book Category</div>
                    <input name="category" type="text" class="form-control" required="">
                    <div class="invalid-feedback">
                        Add E-Book Category Field is Required !!
                    </div>
                    @error('category')
                    <div style="width: 100%;
                    margin-top: 0.25rem;
