    ...
    <div class="card-body">
        ...
        <div class="row m-2 ">
            ...
            <div class="text-right">
                <a href="{{ route('BlogCreate') }}" class="btn btn-lg btn-primary m-2"><i class="fas fa-plus"></i> Create Post</a>
            </div>
                        ...
                        @if ($blogs)
                            @foreach ($blogs as $blog)
                                <tr>
                                    ...
                                    <td>{{ getCategoryName($blog->category_id) }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('BlogEdit', $blog->id) }}" class="btn btn-primary"><i
                                                class="fas fa-edit"></i> Edit</a>

                                        <button type="button" class="btn btn-danger deleteBtn" data-id="{{ $blog->id }}"
                                            data-toggle="modal" data-target="#deleteBlogModel">
