...
<div class="card-body">
    ...
    <div class="text-right">
        <a href="{{ route('CategoryCreate') }}" class="btn btn-lg btn-primary m-2"><i class="fas fa-plus"></i> Create Categories</a>
    </div>
                ...
                <table class="table table-striped" id="table-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('CategoryEdit', $category->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
                                <button data-id="{{ $category->id }}" data-toggle="modal" data-target="#deleteCategoryModel"  class="btn btn-danger deleteBtn" id="deleteButton"><i class="fas fa-trash"></i> Delete</button>
